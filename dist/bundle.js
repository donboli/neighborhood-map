...
module.exports = "<!DOCTYPE html> <html> <head> <title>Neighborhood Map</title> </head> <body> <nav class=\"navbar navbar-default\"> <div class=container-fluid> <div class=navbar-header> <button type=button class=\"navbar-toggle collapsed\" data-toggle=collapse data-target=#bs-example-navbar-collapse-1 aria-expanded=false> <span class=sr-only>Toggle navigation</span> <span class=icon-bar></span> <span class=icon-bar></span> <span class=icon-bar></span> </button> <a class=navbar-brand href=#>Neighborhood Map</a> </div> <div class=\"collapse navbar-collapse\" id=bs-example-navbar-collapse-1> <form data-bind=\"submit: filterPlaces\" class=\"navbar-form navbar-left\"> <div class=row> <div class=col-xs-12> <input data-bind=\"textInput: filter\" type=text class=form-control placeholder=\"Type in some place\"> </div> </div> </form> <div class=row> <div class=col-xs-12> <h2><small>Places</small></h2> <ul data-bind=\"foreach: filteredPlaces\"> <li data-bind=\"text: name\"></li> </ul> </div> </div> </div> </div> </nav> <div class=container-fluid> <div class=row> <div class=\"col-xs-12 nopadding\"> <div id=map></div> </div> </div> </div> <script>function initMap(){window.map=new google.maps.Map(document.getElementById(\"map\"))}</script> <script src=bundle.js></script> <script async defer=defer src=\"https://maps.googleapis.com/maps/api/js?key=AIzaSyDNuTFOEi29eQHK8Z7EvZf4HxbyJ_vqROQ&callback=initMap\"></script> </body> </html>";
